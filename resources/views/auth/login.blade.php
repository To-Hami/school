            ...
            <div class="row justify-content-center no-gutters vertical-align">
                <div class="col-lg-4 col-md-6 login-fancy-bg bg"
                    ...
                    <div class="login-fancy ">
                            ...
                            <h4 class="text-white mb-20 ">مرحبا بك في مدرسة الطائف </h4>
                        ...
                        <ul class="list-unstyled  pos-bot pb-30">
                            ...
                            <li class="list-inline-item"><a class="text-white" href="#"> <h6 style="color: #a7cf5d;font-family: monospace;font-size: 20px">جميع الحقوق محفوظة لدي تقني الطائف .</h6></a></li>
                        </ul>
                    </div>
                </div>
